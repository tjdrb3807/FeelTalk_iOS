...
final class MixpanelRepository {
    ...
    // MARK: Cache
    private var pageCountPair: (String, Int)? = nil
    private var chatTimer: Timer? = nil
    private var questionTimer: Timer? = nil
    private var answerTimer: Timer? = nil
}
