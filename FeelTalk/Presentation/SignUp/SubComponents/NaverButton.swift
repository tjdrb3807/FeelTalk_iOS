...
final class NaverButton: UIButton {
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor = UIColor(named: "naver_button_background")
    ...
    private func setConfig() {
        ...
        buttonTitleLabel.snp.makeConstraints { $0.width.equalTo((UIScreen.main.bounds.width / 100) * 29.86) }
...
struct NaverButton_Previews: PreviewProvider {
    static var previews: some View {
        NaverButton_Presentable()
    }
    
    struct NaverButton_Presentable: UIViewRepresentable {
