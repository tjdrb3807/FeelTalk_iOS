...
enum ChallengeCellNameSpace {
    ...
    static let dateLabelTopInset: CGFloat = CommonConstraintNameSpace.verticalRatioCalculator * 1.97        // 16.0
    static let dateLabelWidth: CGFloat = CommonConstraintNameSpace.horizontalRatioCalculaotr * 14.93        // 56.0
    static let dateLabelHeight: CGFloat = CommonConstraintNameSpace.verticalRatioCalculator * 3.69          // 30.0
    ...
    static let titleLabelTopOffset: CGFloat = CommonConstraintNameSpace.verticalRatioCalculator * 0.98      // 8.0
